...
CREATE TABLE `employeeinfo` (
  ...
  CONSTRAINT `employeeinfo_ibfk_1` FOREIGN KEY (`ManagerID`) REFERENCES `employeeinfo` (`EmployeeID`)
...
INSERT INTO `employeeinfo` VALUES (15,NULL,'Manager','Bill'),(25,15,'IT','John'),(32,15,'Sales','Jimmy'),(35,15,'Temp','Johnson'),(66,15,'Front Desk','John'),(75,15,'Manager','Roosevelt');
