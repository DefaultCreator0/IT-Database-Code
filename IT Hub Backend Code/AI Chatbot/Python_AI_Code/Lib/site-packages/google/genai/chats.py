  ...
  def create(
      ...
      *,
      ...
      config: Optional[GenerateContentConfigOrDict] = types.GenerateContentConfig(
        ...
        system_instruction=[
            types.Part.from_text(text="""You are a chatbot that will ask the user for their name and work ID. After receiving their information you can assist them with whatever they need."""),
        ],)
